...
import { Map, Trees, BookOpen, Users, Settings, BarChart2, MessageSquare, Home } from 'lucide-react'
...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex flex-col bg-brand-dark text-white transition-all duration-200 shrink-0',
        collapsed ? 'w-14' : 'w-52'
      )}
    >
      {/* Logo */}
